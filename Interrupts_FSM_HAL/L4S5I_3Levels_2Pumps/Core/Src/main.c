...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : LEVEL1_Pin LEVEL2_Pin LEVEL3_Pin */
  GPIO_InitStruct.Pin = LEVEL1_Pin|LEVEL2_Pin|LEVEL3_Pin;
